...
public class CrashConfig implements Serializable {
  ...
  public CrashConfig() {
    restartAppButtonText = R.string.restart_app_button_text;
    restartActivityEnable = true;
    closeAppButtonText = R.string.close_app_button_text;
    closeActivityEnable = true;

    crashText = R.string.crash_text;
    crashTextColor = R.color.crash_text;
    detailsButtonText = R.string.details_button_text;
    detailsDialogTitle = R.string.details_dialog_title;
    detailsDialogButtonText = R.string.details_dialog_button_text;
    imagePath = R.drawable.cow_error;
    backgorundColor = R.color.backgorund;
  }
